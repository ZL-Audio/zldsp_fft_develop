...
def run_benchmark_collect(exe_path, n0, n1):
    ...
    results = {
        "AoS to AoS CFFT forward": {},
        "SoA to SoA CFFT forward": {}
    }
    ...
    final_results = {}
    for bench_key in ["AoS to AoS CFFT forward", "SoA to SoA CFFT forward"]:
        th_list = []
...
def main():
    parser = argparse.ArgumentParser(description="Throughput Benchmark for zldsp CFFT (AoS vs SoA)")
    ...
    try:
        exe_path = build_benchmark("zldsp", "throughput_zldsp_cfft",
